    ...
    def is_complete(self):
        ...
        if isstatic:
            ...
            if reachedaccuracy:
                ...
                if usertime:
                    #if bool(self.keywords['program_keys']['conv_nsw']): ## ZS: special case for structopt
                    #    self.logger.info("OUTCAR at %s does not show reached required accuracy, but nsw has reached and shows complete." % opath)
                    #    return True
