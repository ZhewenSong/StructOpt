...
class FEMSIM_eval(object):
    ...
    def read_inputs(self):
        args = json.load(open('femsim_inputs.json'))
    ...
    def evaluate_fitness(self):
        self.write_paramfile(self.individ)
        vk = self.run_femsim()
        chi2 = self.chi2(vk)
        stro = ""
        return chi2, stro
    ...
    def write_paramfile(self, individual):
        ...
        ase.io.xyz.write_xyz(open('structure.xyz', 'w'), individual[0], comment="{} {} {}".format(self.args['xsize'], self.args['ysize'], self.args['zsize']))
